...
# initialize a dictionary to store the number of tweets for each game
scatter_dict = {}
                ...
                html.Div(
                    [
                        html.A(
                            ...
                            href='https://www.blockchainpresence.net',
                            target='_blank',
                            className="app__header__title"
                        ),
                        html.P(
                            "Twitter Stream for Topics of Interest",
